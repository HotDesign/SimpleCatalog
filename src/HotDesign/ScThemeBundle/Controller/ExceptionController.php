...
class ExceptionController extends ContainerAware
{
    ...
    protected function findTemplate($templating, $format, $code, $debug)
    {
        ...
        $bundle = 'HotDesignScThemeBundle';
        if (!$debug) {
            $template = new TemplateReference($bundle, 'Exception', $name.$code, $format, 'twig');
        ...
        $template = new TemplateReference($bundle, 'Exception', $name, $format, 'twig');
        if ($templating->exists($template)) {
            return $template;
        }
        ...
        return new TemplateReference($bundle, 'Exception', $name, 'html', 'twig');
    }
}
